...
export const config = {
  ...
  /** Auth routes (login/register): per IP */
  rateLimitAuthWindowMs: parseInt(optional('RATE_LIMIT_AUTH_WINDOW_MS', '900000'), 10),
  rateLimitAuthMax: parseInt(optional('RATE_LIMIT_AUTH_MAX', '5'), 10),
  /** All /api/v1 traffic: per IP */
  rateLimitGeneralWindowMs: parseInt(optional('RATE_LIMIT_GENERAL_WINDOW_MS', '900000'), 10),
  rateLimitGeneralMax: parseInt(optional('RATE_LIMIT_GENERAL_MAX', '100'), 10),
  /** AI caption/image: per authenticated user */
  rateLimitAiWindowMs: parseInt(optional('RATE_LIMIT_AI_WINDOW_MS', '3600000'), 10),
  rateLimitAiMax: parseInt(optional('RATE_LIMIT_AI_MAX', '20'), 10),
  /** Social publish: per user per rolling day */
  rateLimitPublishDayWindowMs: parseInt(optional('RATE_LIMIT_PUBLISH_DAY_WINDOW_MS', '86400000'), 10),
  rateLimitPublishDayMax: parseInt(optional('RATE_LIMIT_PUBLISH_DAY_MAX', '30'), 10),
